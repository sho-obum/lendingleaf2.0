...
import { ArrowRight as ArrowRightIcon, ChevronDown as ChevronDownIcon } from "lucide-react";
...
export function NavGridCard({ link, ...props }: React.ComponentProps<"div"> & { link: NavItemType }) {
  return (
...
export function NavSmallItem({ item, className, ...props }: React.ComponentProps<typeof NavigationMenuLink> & { item: Omit<NavItemType, "description"> }) {
  return (
    <NavigationMenuLink
      className={cn(
...
export function NavLargeItem({ link, className, ...props }: React.ComponentProps<typeof NavigationMenuLink> & { link: NavItemType }) {
  return (
    <NavigationMenuLink
      className={cn(
...
export function NavItemMobile({ item, className, ...props }: React.ComponentProps<'a'> & { item: NavItemType }) {
  return (
    <a
      className={cn(
